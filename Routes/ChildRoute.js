...
router
    ...
    .post(uploadChildImage,resizeImage,insertValidator,validatonResult,controller.insertChild)


router
    .route("/child/:id")
    .get(controller.getChildById)
    .patch(uploadChildImage,resizeImage,updateValidator,validatonResult,controller.updateChild)
    .delete(deleteValidator,validatonResult,controller.deleteChild);    
